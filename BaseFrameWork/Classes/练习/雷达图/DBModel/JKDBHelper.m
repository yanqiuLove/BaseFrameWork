...
+ (NSString *)dbPathWithDirectoryName:(NSString *)directoryName
{
    ...
    if (directoryName == nil || directoryName.length == 0) {
        docsdir = [docsdir stringByAppendingPathComponent:@"SC_DB"];
    } else {
    ...
    NSString *dbpath = [docsdir stringByAppendingPathComponent:@"classroom.sqlite"];
    return dbpath;
}

+ (NSString *)dbPath
{
    NSString *dirName = [NSString stringWithFormat:@"classroom"];
    return [self dbPathWithDirectoryName:dirName];
}
